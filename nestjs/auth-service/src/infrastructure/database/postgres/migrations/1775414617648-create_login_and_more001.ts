...
export class CreateLoginAndMore0011775414617648 implements MigrationInterface {
    name = 'CreateLoginAndMore0011775414617648'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "sessions" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "user_id" character varying NOT NULL, "role" character varying NOT NULL, "refresh_token" character varying NOT NULL, "device_info" character varying, "ip_address" character varying, "expires_at" TIMESTAMP NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_3238ef96f18b355b671619111bc" PRIMARY KEY ("id"))`);
